...
const Sidebar = ({ isMobileMenuOpen, setIsMobileMenuOpen }) => {
  ...
  <div className="flex justify-center">
    ...
    />
        ...
        {/* BOTTOM: User + Logout (style original) */}
        <div className="flex-shrink-0 p-3 pt-2 border-t border-slate-100">
          ...
          {/* Logout button - design original (fond rouge clair) */}
          <button
      ...
      <aside
        ...
        `}
      >
        {/* Mobile header avec Menu button intégré */}
        {/* Mobile header avec Menu button intégré */}
<div className="flex items-center justify-between px-4 py-4 border-b border-slate-100 relative">
  <div className="w-8"></div> {/* Espace vide à gauche pour équilibrer */}
  ...
  >
    <X className="h-4 w-4 text-slate-500" />
        ...
        <div className="flex-shrink-0 p-4 pt-2 border-t border-slate-100">
          ...
          {/* Logout mobile - design original avec fond rouge clair */}
          <button
            onClick={handleLogout}
